class OTBHCConfig:
    ...
    num_samples = 60                    # maximum number of stored training samples
    ...
    skip_after_frame = 20                # after which frame number the sparse update scheme should start (1 is directly)
