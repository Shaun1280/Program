#ifndef METANN_OPERATORS_DIVIDE_H
#define METANN_OPERATORS_DIVIDE_H
...
template <typename TP1, typename TP2> struct OperDivide_ {
    // valid check
  private:
  ...
  public:
    ...
    static auto Eval(TP1&& p_m1, TP2&& p_m2) {
        ...
        using ResType = BinaryOp<BinaryOpTags::Divide, rawM1,
...
template <typename TP1, typename TP2,
          std::enable_if_t<OperDivide_<TP1, TP2>::valid, bool> = true>
auto operator/(TP1&& p_m1, TP2&& p_m2) {
    return OperDivide_<TP1, TP2>::template Eval<DataCategory<TP1>,
                                                DataCategory<TP2>>(
